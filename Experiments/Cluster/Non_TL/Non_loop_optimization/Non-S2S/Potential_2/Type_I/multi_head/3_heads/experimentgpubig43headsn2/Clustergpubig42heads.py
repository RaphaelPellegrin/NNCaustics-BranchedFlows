...
def N_heads_run_Gaussiann(initial_x=0, final_t=50, means=[[7.51, 4.6], [8.78, 6.16]], alpha_=1, width_=40, width_heads=8, \
  epochs_=20000, grid_size=200, number_of_heads=3, PATH="models", print_legend=False, loadWeights=False, energy_conservation=True,\
   norm_clipping=True):
  '''
...
if __name__=='__main__':
 ...
 [45.65, 18.15],
 [27.99, 40.4]]
  N_heads_run_Gaussiann(grid_size=20000, means=means_cell,final_t=14, width_=64, width_heads=32, epochs_=50000)

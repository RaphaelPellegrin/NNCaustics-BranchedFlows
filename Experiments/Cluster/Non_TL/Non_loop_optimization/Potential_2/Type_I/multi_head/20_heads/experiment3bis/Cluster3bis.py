...
class MyNetwork_Ray_Tracing(nn.Module):
    ...
    """
    def __init__(self, number_dims=100, number_dims_heads=100, depth_body=10,  N=1):
...
if __name__=='__main__':
  ...
  N_heads_run_Gaussiann(means=means_cell,final_t=14, width_=64, width_heads=32, epochs_=25000)
